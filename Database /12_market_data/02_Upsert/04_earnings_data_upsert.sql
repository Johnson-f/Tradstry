...
BEGIN
    INSERT INTO earnings_data (
        ...
        p_symbol, p_exchange_id, p_fiscal_year, p_fiscal_quarter, p_reported_date,
...
COMMENT ON FUNCTION upsert_earnings_data IS 'Upserts earnings data with conflict resolution on symbol, fiscal_year, fiscal_quarter, and data_provider';
