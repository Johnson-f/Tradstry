DROP TABLE market_movers CASCADE;
...
DROP FUNCTION IF EXISTS get_top_gainers CASCADE;
DROP FUNCTION IF EXISTS get_top_losers CASCADE;
DROP FUNCTION IF EXISTS get_most_active CASCADE;
