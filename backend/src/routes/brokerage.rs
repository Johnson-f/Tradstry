...
pub async fn get_connection_status(
    ...
    match connections::get_connection_status(&conn, &connection_id, &user_id, &snaptrade_client).await {
...
pub async fn delete_connection(
    ...
    match connections::delete_connection(&conn, &connection_id, &user_id, &snaptrade_client).await {
        Ok(_) => Ok(HttpResponse::Ok().json(ApiResponse::success(serde_json::json!({
        "success": true,
...
pub async fn get_account_transactions(
    ...
    match accounts::get_account_transactions_from_snaptrade(&conn, &account_id, &user_id, &query.into_inner(), &snaptrade_client).await {
        Ok(transactions_data) => Ok(HttpResponse::Ok().json(ApiResponse::success(transactions_data))),
        Err(e) => {
...
pub async fn get_account_option_positions(
    ...
    match accounts::get_account_option_positions(&conn, &account_id, &user_id, &snaptrade_client).await {
        Ok(positions_data) => Ok(HttpResponse::Ok().json(ApiResponse::success(positions_data))),
        Err(e) => {
...
pub async fn complete_connection_sync(
    ...
    match connections::complete_connection_sync(&conn, &connection_id, &user_id, &snaptrade_client).await {
        Ok(summary) => Ok(HttpResponse::Ok().json(ApiResponse::success(summary))),
        Err(e) => {
