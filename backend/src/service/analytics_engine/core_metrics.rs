...
pub async fn calculate_symbol_analytics(
    ...
    let total_avg_gain = if total_winning > 0 {
        (avg_gain_stocks * winning_trades_stocks as f64 + avg_gain_options * winning_trades_options as f64) / total_winning as f64
    } else {
        0.0
    };
    ...
    let total_avg_loss = if total_losing > 0 {
        (avg_loss_stocks * losing_trades_stocks as f64 + avg_loss_options * losing_trades_options as f64) / total_losing as f64
    } else {
        0.0
    };
