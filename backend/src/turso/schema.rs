...
pub fn get_current_schema_version() -> SchemaVersion {
    SchemaVersion {
        ...
        description: "Added exit_price column to stocks and options tables".to_string(),
    ...
    let mut schemas: Vec<TableSchema> = vec![
        ...
        TableSchema {
            ...
            columns: vec![
                ...
                ColumnInfo { name: "exit_price".to_string(), data_type: "DECIMAL(15,8)".to_string(), is_nullable: false, default_value: None, is_primary_key: false },
                ...
                ColumnInfo { name: "exit_date".to_string(), data_type: "TIMESTAMP".to_string(), is_nullable: false, default_value: None, is_primary_key: false },
