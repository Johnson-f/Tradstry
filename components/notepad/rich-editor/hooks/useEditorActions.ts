...
async function sendEditorState(editor: { getEditorState: () => unknown }): Promise<void> {
...
export function useEditorActions(shouldPreserveNewLinesInMarkdown: boolean = false) {
