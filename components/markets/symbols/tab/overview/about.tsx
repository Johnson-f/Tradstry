...
export function About({ symbol, className }: AboutProps) {
  ...
  const data = useMemo(() => {
    ...
    return {
      prevClose: undefined as number | undefined, // not provided by current API
      open: toNumber(quote.open),
      dayRange,
      range52W,
      marketCap: quote.marketCap ?? undefined,
      pe: toNumber(quote.pe),
      dividendYield: undefined as string | undefined,
      volume: quote.volume ?? undefined,
      eps: undefined as number | undefined,
    };
  }, [quote]);
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <ValueCell>{data.pe !== undefined ? data.pe : "—"}</ValueCell>
            ...
            <TableRow>
              ...
              <ValueCell className="!text-right">{data.eps !== undefined ? data.eps : "—"}</ValueCell>
            </TableRow>
          </TableBody>
        </Table>
      </div>
