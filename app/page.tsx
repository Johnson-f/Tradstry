      ...
      <div className="flex-1 w-full flex flex-col gap-20 items-center">
        ...
        <div className="flex-1 flex flex-col gap-20 max-w-5xl p-5">
          <div className="flex flex-col gap-6 px-4">
            <h2 className="font-medium text-xl mb-4">Welcome to Tradstry</h2>
            <p>
              Tradstry is a platform for trading and investing. It is a work in progress and will be updated regularly.
            </p>
            <p>
